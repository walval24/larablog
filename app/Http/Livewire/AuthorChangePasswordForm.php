...
class AuthorChangePasswordForm extends Component
{
    ...
    public function changePassword()
    {
        $this->validate([
            ...
            'current_password.required' => 'Enter youre current password',
            'new_password.required' => 'Enter new Password',
            'confirm_new_password.same' => 'Passwords must match',
        ]);
        ...
        if ($query) {
            ...
            $this->showToastr('Ops! something went wrong', 'error');
        }
    }
...
//Build a Blog with Laravel #15 Change Profile picture